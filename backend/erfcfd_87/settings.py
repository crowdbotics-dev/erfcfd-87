"""
Django settings for erfcfd_87 project.
...
WSGI_APPLICATION = 'erfcfd_87.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "erfcfd_87 API",
    "DESCRIPTION": "API documentation for erfcfd_87 App",
    "VERSION": "v1",
}
